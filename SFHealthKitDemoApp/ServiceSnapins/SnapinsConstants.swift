...
class SnapinsConstants {
  ...
  static let CHAT_POD_NAME = "d.la3-c2-fra.salesforceliveagent.com"
  static let CHAT_ORG_ID = "00D09000002YUJE"
  static let CHAT_DEPLOYMENT_ID = "572090000000GbK"
  static let CHAT_BUTTON_ID = "573090000000Gkn"
