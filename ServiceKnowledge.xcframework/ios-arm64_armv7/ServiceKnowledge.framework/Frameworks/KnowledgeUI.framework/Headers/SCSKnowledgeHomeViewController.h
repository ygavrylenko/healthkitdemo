 ...
 */
typedef NS_ENUM(NSInteger, SCSChevronAlignment) {
...
/**
 Position alignment of the data category header view chevrons. The default position is `SCSChevronAlignmentTrailing`.
 */
@property (nonatomic, assign) SCSChevronAlignment chevronAlignment;
