...
/**
 ...
 @warning This method may not be called when a user navigates between Smart Link articles, though the `articleController:didShowArticle:` method will still be invoked in that condition.
